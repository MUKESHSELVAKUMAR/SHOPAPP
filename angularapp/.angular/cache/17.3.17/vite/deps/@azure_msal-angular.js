...
import {
  ...
  NavigationClient,
  WrapperSKU
} from "./chunk-BHZZXKYC.js";
import "./chunk-DJE3DEWG.js";
import "./chunk-TZC55MQJ.js";
import "./chunk-LYM5C22Y.js";
import {
  CommonModule,
  DOCUMENT,
  Location
...
var MsalBroadcastService = class _MsalBroadcastService {
  ...
  static {
    this.ɵfac = function MsalBroadcastService_Factory(t) {
      return new (t || _MsalBroadcastService)(ɵɵinject(MSAL_INSTANCE), ɵɵinject(NgZone), ɵɵinject(MSAL_BROADCAST_CONFIG, 8));
    };
  }
  static {
...
var MsalService = class _MsalService {
  ...
  static {
    this.ɵfac = function MsalService_Factory(t) {
      return new (t || _MsalService)(ɵɵinject(MSAL_INSTANCE), ɵɵinject(Location), ɵɵinject(Injector));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
...
var MsalGuard = class _MsalGuard {
  ...
  static {
    this.ɵfac = function MsalGuard_Factory(t) {
      return new (t || _MsalGuard)(ɵɵinject(MSAL_GUARD_CONFIG), ɵɵinject(MsalBroadcastService), ɵɵinject(MsalService), ɵɵinject(Location), ɵɵinject(Router));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
...
var MsalInterceptor = class _MsalInterceptor {
  ...
  matchScopesToEndpoint(protectedResourceMap, endpointArray, httpMethod) {
    ...
    endpointArray.forEach((matchedEndpoint) => {
      ...
      if (methodAndScopesArray === void 0) {
        return;
      }
  ...
  static {
    this.ɵfac = function MsalInterceptor_Factory(t) {
      return new (t || _MsalInterceptor)(ɵɵinject(MSAL_INTERCEPTOR_CONFIG), ɵɵinject(MsalService), ɵɵinject(Location), ɵɵinject(MsalBroadcastService), ɵɵinject(DOCUMENT));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
...
var MsalRedirectComponent = class _MsalRedirectComponent {
  ...
  static {
    this.ɵfac = function MsalRedirectComponent_Factory(t) {
      return new (t || _MsalRedirectComponent)(ɵɵdirectiveInject(MsalService));
    };
  }
  static {
...
var MsalModule = class _MsalModule {
  ...
  static {
    this.ɵfac = function MsalModule_Factory(t) {
      return new (t || _MsalModule)();
    };
  }
  static {
...
var MsalCustomNavigationClient = class _MsalCustomNavigationClient extends NavigationClient {
  ...
  static {
    this.ɵfac = function MsalCustomNavigationClient_Factory(t) {
      return new (t || _MsalCustomNavigationClient)(ɵɵinject(MsalService), ɵɵinject(Router), ɵɵinject(Location));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
